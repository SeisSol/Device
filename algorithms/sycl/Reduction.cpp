...
void launchReduction(AccT* result,
                     const VecT* buffer,
                     size_t size,
                     OpT operation,
                     bool overrideResult,
...
void Algorithms::reduceVector(AccT* result,
  ...
  case ReductionType::Add: {
    return launchReduction<ReductionType::Add>(
        result, buffer, size, sycl::plus<AccT>(), overrideResult, streamPtr);
  }
  case ReductionType::Max: {
    return launchReduction<ReductionType::Max>(
        result, buffer, size, sycl::maximum<AccT>(), overrideResult, streamPtr);
  }
  case ReductionType::Min: {
    return launchReduction<ReductionType::Min>(
        result, buffer, size, sycl::minimum<AccT>(), overrideResult, streamPtr);
  }
  }
}
