...
if (${DEVICE_BACKEND} STREQUAL "HIPSYCL")
    ...
    elseif("$ENV{PREFERRED_DEVICE_TYPE}" STREQUAL "GPU")
        target_compile_options(device PRIVATE "-fsycl" "-fsycl-targets=nvptx64-nvidia-cuda-sycldevice" "-fsycl-unnamed-lambda" "-Xsycl-target-backend" "--cuda-gpu-arch=sm_70")
