...
target_link_libraries(${TARGET_NAME} PUBLIC device stdc++fs)
...
if (${DEVICE_BACKEND} STREQUAL "HIPSYCL")
    ...
    elseif("$ENV{PREFERRED_DEVICE_TYPE}" STREQUAL "GPU")
        target_compile_options(${TARGET_NAME} PRIVATE "-fsycl" "-fsycl-targets=spir64_gen-unknown-unknown-sycldevice")
    ...
    elseif("$ENV{PREFERRED_DEVICE_TYPE}" STREQUAL "CPU")
        target_compile_options(${TARGET_NAME} PRIVATE "-fsycl -fsycl" "-fsycl-targets=spir64_x86_64-unknown-unknown-sycldevice")
