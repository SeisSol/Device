...
if (${DEVICE_BACKEND} STREQUAL "acpp")
    find_package(OpenSYCLSettings REQUIRED)
    find_package(OpenSYCL REQUIRED)
    target_link_libraries(${TARGET_NAME} PRIVATE acpp-settings::device_flags)
    target_link_libraries(${TARGET_NAME} PUBLIC acpp-settings::interface)
