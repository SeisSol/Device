...
public:
  ...
  void *allocCompressibleGlobMem(size_t size) override;
  ...
  void freeCompressibleMem(void *devPtr) override;
...
private:
  ...
  bool useCompressibleMemory{false};
  std::unordered_map<void*, size_t> compressibleMemSizesTable{};
